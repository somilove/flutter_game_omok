        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              for( j = 0 ; j < controller.v_colBox.value ; j ++) Expanded(flex: 9, child: Container(
                child: Row(
                    children: [
                      Expanded(flex: 4, child: Container(),),
                      for ( i = 0 ; i < controller.v_rowBox.value ; i++  ) Expanded(flex: 9, child:Container(
                        child: Image.asset(
            ...
            children: [
              ...
              for( int l = 0; l< controller.v_colBox.value ; l++) Expanded(
                  ...
                  child: Row(
                    children: [
                      Expanded(flex: 4, child: Container(),),
                      for(int k = 0 ; k < controller.v_rowBox.value ; k ++ ) Expanded(flex: 9, child: Container(
